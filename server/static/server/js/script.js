...
document.addEventListener("visibilitychange", function () {
  if (document.visibilityState === "visible") {
    document.title = "coDestress | Mental Assistant";
    $("#favicon").attr("href", "https://cdn.discordapp.com/attachments/957946068836950026/1082593462391668786/music_therapy.png");
  } else {
    document.title = "An Application Of Vision AI";
    $("#favicon").attr("href", "https://cdn.discordapp.com/attachments/957946068836950026/1082593462391668786/music_therapy.png");
  }
});
...
let dataTyping = {
  target: "typing-text",
  text: '["Django Channels","OpenCV","Spotify Web API","Spotify iFrame API","Youtube Music API","ResponsiveVoice API"]',
  delay: "1000",
};
